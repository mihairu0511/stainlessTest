...
class Stainlesstest(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Stainlesstest client instance.

        This automatically infers the `api_key` argument from the `STAINLESSTEST_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
...
class AsyncStainlesstest(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncStainlesstest client instance.
...
AsyncClient = AsyncStainlesstest
